...
export async function generateMetadata({
  ...
  const title = settings?.contactPageTitle || 'Contact Us'
  const description = settings?.contactPageDescription || 'Get in touch with Kilalo.'
    ...
    <div className="container py-16 md:py-24">
      ...
      <div className="mx-auto mb-16 max-w-3xl text-center">
        ...
        <div className="inline-flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>
            {settings?.contactBusinessHoursTitle || 'We typically respond within 24-48 hours'}
          </span>
        </div>
      </div>
      ...
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2 border-teal/30 bg-gradient-to-br from-teal/5 to-teal/10">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-teal">
                ...
                {settings?.contactPhoneTitle || 'WhatsApp'}
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-teal">{settings?.contactEmailTitle || 'Email'}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-orange">
                {settings?.contactAddressTitle || 'Our Offices'}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <h4 className="mb-1 font-semibold">Goma Office</h4>
              ...
              <div className="border-t pt-4">
                <h4 className="mb-1 font-semibold">Kinshasa Office</h4>
                <p className="text-sm text-muted-foreground">Address coming soon</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-forest">
                {settings?.contactFollowTitle || 'Follow Us'}
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="rounded-lg bg-gradient-to-r from-teal/10 to-orange/10 p-6">
            <h3 className="mb-2 font-semibold">Need immediate assistance?</h3>
            <p className="text-sm text-muted-foreground">
              For urgent inquiries, please email us directly and we'll respond as quickly as
              possible.
            </p>
          </div>
        </div>
